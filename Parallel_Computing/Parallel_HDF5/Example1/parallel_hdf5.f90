!=====================================================================
! Program: parallel_hdf5.f90
!          Program creates a random vector, distributes it to
!          parallel MPI processes, and writes it in parallel
!          to disk to HDF5 (.h5) file
!          
...
program main
  ...
  ! HDF5 stuff........................................................
  character(len=10), parameter :: filename = "pset_1d.h5"  ! File name
  ...
  integer(HSIZE_T)  :: dimsf(1)                            ! Dataset dimensions.
  ...
  if ( .not. allocated(b) ) allocate( b(ista:iend) )
  do i = 1, n
     if ( ( i >= ista ) .and. ( i <= iend ) ) then
        b(i) = a(i)
     end if
  end do
