...
## Examples
* [Example 1](Example1): OpenMP parallel region (C)
* [Example 2](Example2): OpenMP diagonalization of a symmetric matrix (Fortran)
* [Example 3](Example3): OpenMP scaling illustartion - Parallel Monte Carlo calculation of $\pi$ (C)
