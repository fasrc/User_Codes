...
**Molecular Dynamics (MD) -** Program implements a simple molecular dynamics simulation.

### Contents:

* <code>omp_md.c</code>: C source code
* <code>omp_md.dat</code>: Output file
