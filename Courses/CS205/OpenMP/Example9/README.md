...
**Poisson Equation -** A program for solving the Poisson problem.

### Contents:

* <code>omp_poisson.c</code>: C source code
* <code>omp_poisson.dat</code>: Output file
...
POISSON_OPENMP:
  ...
  The X grid spacing is 0.006250
  The Y grid spacing is 0.006250
  RMS of F = 5.91904
